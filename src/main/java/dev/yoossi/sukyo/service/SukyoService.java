...
public class SukyoService {
    ...
    private final SukyoCalendarService calendarService;
    ...
    public StarResponse resolveStar(BirthRequest request) {
        ...
        int index = calendarService.getStarIndex(date);
    ...
    public CompatibilityResponse resolveCompatibility(LocalDate me, LocalDate partner) {
        int myIndex = calendarService.getStarIndex(me);
        int partnerIndex = calendarService.getStarIndex(partner);
