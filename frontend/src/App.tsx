    ...
    <div className="app">
      ...
      {screen === "result" && star && (
        <div className="screen">
          ...
          <Section n="01" title="개인 성향">{star.temperament}</Section>
          <Section n="02" title="연애 성향">{star.love}</Section>

          <div className="hook-box">
            <p className="hook-text">{star.hookQuestion}</p>
            <button className="cta outline small-full">내 {star.koreanName} 더 깊게 보기</button>
          </div>
